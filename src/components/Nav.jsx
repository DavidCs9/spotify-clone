export function Nav () {
  return (
    <div id='nav' className='bg-black bg-opacity-50 flex items-center justify-between w-full h-16 px-6'>
      <div id='topbar' className=' text-spotify-font-gray  flex justify-between w-28 px-6'>
        <button>
      ...
      <div id='navbar' className='text-white flex gap-6 font-semibold'>
