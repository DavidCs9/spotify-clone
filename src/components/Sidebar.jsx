export function Sidebar () {
  return (
    <div className='h-screen'>
      <div id='sidebar' className='bg-black w-72 h-screen text-spotify-font-gray'>
        <div id='logo' className='flex text-white px-6 mb-6 gap-2 pt-6 text-2xl font-semibold'>
        ...
        <div id='btn English' className=' px-6'>
          <button className='bg-black border-[1px] rounded-full border-gray-500 h-8 px-4 text-white flex justify-center items-center gap-1 font-medium'>
